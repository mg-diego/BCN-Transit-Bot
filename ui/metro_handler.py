...
class MetroHandler:
    ...
    async def show_lines(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await self.message_service.edit_inline_message(update, "⏳ Cargando líneas de metro...")
        metro_lines = await self.metro_service.get_all_lines()
        reply_markup = self.keyboard_factory.metro_lines_menu(metro_lines)
        await self.message_service.edit_inline_message(update, "Elige una línea de metro:", reply_markup=reply_markup)
    ...
    async def show_line_stations(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await self.message_service.edit_inline_message(update, f"Estaciones de la línea {line_id}:", reply_markup=reply_markup)
